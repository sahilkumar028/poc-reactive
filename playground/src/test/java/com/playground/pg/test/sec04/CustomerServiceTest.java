package com.playground.pg.test.sec04;
...
@SpringBootTest(properties = "sec=s04")
public class CustomerServiceTest {
    ...
    public void customerNotFound(){
            this.client.get()
                    ...
                    .expectBody()
                    .jsonPath("$.detail")
                    .isEqualTo("Customer [id=343] is not found");
        this.client.delete()
                .uri("/customer/343")
                .exchange()
                .expectStatus().is4xxClientError()
    ...
    public void invalidInput(){
        this.client.post()
                .uri("/customer")
                .bodyValue(new CustomerDto(null,null,"sahil@gmail.com"))
                .exchange()
                .expectStatus().is4xxClientError()
                .expectBody().jsonPath("$.detail")
        ...
        this.client.post()
                .uri("/customer")
                .bodyValue(new CustomerDto(null,"sahil",null))
                .exchange()
                .expectStatus().is4xxClientError()
                .expectBody().jsonPath("$.detail")
                .isEqualTo("valid Email required");
    }
